...
<script>
    $(document).ready(function() {
        ...
        window.editUser = function(userId) {
            const url = '{{ route("admin.category.get", ":userid") }}'.replace(":userid", userId);
            $.ajax({
                url: url,
                method: 'GET',
                success: function(data) {
                    ...
                    setFlash("success", 'category found successfully.');
                },
                error: function() {
                    setFlash("error", "category not found. Please try again later.");
                }
            });
        };
        ...
        window.deleteUser = function(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = '{{ route("admin.category.destroy", ":userId") }}'.replace(":userId", userId);
                    $.ajax({
                        type: "DELETE",
                        url,
